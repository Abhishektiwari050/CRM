...
(() => {
   ...
   const config = {
      employee: [
         ...
         { icon: 'clipboard', text: 'Log Activity', href: '/activity_logging_page/code.html', id: 'activity' },
         { icon: 'file-text', text: 'Daily Report', href: '/daily_work_report/code.html', id: 'report' },
